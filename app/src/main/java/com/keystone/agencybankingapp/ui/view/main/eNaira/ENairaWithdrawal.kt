...
import com.keystone.agencybankingapp.databinding.FragmentENairaWithdrawalBinding
import com.keystone.agencybankingapp.ui.view.main.openAccountScreens.AppConstants

class ENairaWithdrawal : Fragment() {
    private lateinit var binding: FragmentENairaWithdrawalBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_e_naira_withdrawal, container, false)
        return binding.root
    }
    ...
    override fun onResume() {
        ...
        fingerPrintScanner.setOnClickListener {
            AppConstants.runFingerPrintScanner(
                requireContext(),
                binding.root,
                requireActivity(),
                getCancellationSignal()
            ) {
                Toast.makeText(requireContext(), getString(R.string.completed), Toast.LENGTH_SHORT)
                    .show()
            }
        }
    }
